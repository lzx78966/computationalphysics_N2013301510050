...
b = baseball(flight_state(0,0,0,15,0,2,0), _dt = 0.01)
b.shoot()
b.show_trajectory("blue")
c = baseball(flight_state(0,0,0,20,0,2,0), _dt = 0.01)
c.shoot()
c.show_trajectory("yellow")
d = baseball(flight_state(0,0,0,25,0,2,0), _dt = 0.01)
d.shoot()
d.show_trajectory("cyan")
pl.legend()
pl.show()
e = baseball(flight_state(0,0,0,30,0,2,0), _dt = 0.01)
e.shoot()
e.show_trajectory("orange")
f = baseball(flight_state(0,0,0,30,0,4,0), _dt = 0.01)
f.shoot()
f.show_trajectory("pink")
g = baseball(flight_state(0,0,0,30,0,6,0), _dt = 0.01)
g.shoot()
g.show_trajectory("green")
h = baseball(flight_state(0,0,0,30,0,8,0), _dt = 0.01)
h.shoot()
